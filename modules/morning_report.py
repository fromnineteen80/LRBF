...
def generate_morning_html(forecast: Dict, output_path: str = None) -> str:
    ...
    Example:
        ...
        >>> from modules.morning_report import generate_morning_html
        >>> 
    ...
    # This connects morning report → live monitor → EOD report
    db = TradingDatabase()
    try:
        ...
        print(f"   ⚠️  Warning: Failed to store forecast in database: {e}")
...
def _build_stock_cards(stocks: list) -> str:
    ...
    html = '<h2 class="section-title">📈 Selected Stocks (Ranked by Quality Score)</h2>'
...
def _build_forecast_section(ranges: Dict, portfolio: Dict) -> str:
    ...
    <div class="forecast-section">
        <h2 class="section-title">💰 Portfolio Forecast (Today's Expected Performance)</h2>
        ...
        <div class="forecast-grid">
            ...
            <div class="forecast-metric">
                ...
                <div class="forecast-metric-range">{portfolio.get('num_positions', 0)} positions × ${portfolio.get('position_size', 0):,.0f}</div>
            </div>
...
def _build_fund_status() -> str:
    ...
    <div class="fund-status">
        <h2 class="section-title">📊 Fund Status</h2>
...
def _build_footer() -> str:
    ...
    return """
    <div class="footer">
        <p>Built with ❤️ for The Luggage Room Boys Fund</p>
...
if __name__ == "__main__":
    ...
    from modules.stock_selector import select_balanced_portfolio, get_portfolio_configurations
    from modules.forecast_generator import generate_daily_forecast
    ...
    from modules.capitalise_prompts import generate_capitalise_prompts
    selected_tickers = [stock['ticker'] for stock in forecast['stocks']]
    prompt_files = generate_capitalise_prompts(selected_tickers)
    print(f"   ✅ Generated {len(prompt_files)} prompts")
    print(f"   📁 Saved to: /home/claude/railyard/output/capitalise_prompts/")
    print()
