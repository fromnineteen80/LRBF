...
import time
from backend.core.pattern_detector import analyze_patterns_with_outcomes, get_pattern_summary
from backend.data.stock_universe import get_stock_universe, get_sample_tickers
...
def download_stock_data(
    ...
    try:
        from backend.data.data_provider import get_data_provider
    except ImportError:
